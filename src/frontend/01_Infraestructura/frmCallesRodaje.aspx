<%@ Page Title="Calles de Rodaje" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeFile="frmCallesRodaje.aspx.vb" Inherits="frmCallesRodaje" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">Calles de Rodaje</asp:Content>
...
<div class="container-fluid px-4 py-3">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold mb-0" style="color:#0d2040;"><i class="bi bi-signpost-split-fill me-2" style="color:#c5a059;"></i>Calles de Rodaje</h2>
            <nav aria-label="breadcrumb"><ol class="breadcrumb mb-0 small">
                <li class="breadcrumb-item"><a href="/06_Seguridad_Finanzas/Dashboard.aspx">Inicio</a></li>
                <li class="breadcrumb-item active">Calles de Rodaje</li>
            </ol></nav>
        </div>
        <asp:Panel ID="pnlBtnNuevo" runat="server">
            <button type="button" class="btn btn-sm text-white" style="background:#c5a059;" onclick="abrirModal()">
                <i class="bi bi-plus-lg me-1"></i> Nueva Calle
            </button>
        </asp:Panel>
    </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
            <h6 class="fw-bold mb-0 text-secondary"><i class="bi bi-list-ul me-2"></i>Listado de Calles de Rodaje</h6>
            <asp:Label ID="lblConteo" runat="server" CssClass="badge bg-light text-dark border"></asp:Label>
        </div>
        <div class="card-body p-0">
            <div class="table-responsive">
                <asp:GridView ID="gvCalles" runat="server" CssClass="table table-hover align-middle mb-0"
                    AutoGenerateColumns="false" EmptyDataText="No hay calles de rodaje para mostrar."
                    DataKeyNames="ID_TAXIWAY" OnRowCommand="gvCalles_RowCommand">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Acciones" ItemStyle-CssClass="tbl-action">
                            <ItemTemplate>
                                <asp:LinkButton runat="server" CommandName="Editar" CommandArgument='<%# Eval("ID_TAXIWAY") %>'
                                ...
                                <asp:Panel ID="pnlDesactivar" runat="server" style="display:inline-block;"
                                    ...
                                    <asp:LinkButton runat="server" CommandName="Eliminar" CommandArgument='<%# Eval("ID_TAXIWAY") %>'
                                        CssClass="btn btn-xs btn-outline-danger" Text="⊘"
                                        OnClientClick="return confirm('¿Desactivar esta calle?');">
                                    </asp:LinkButton>
                                </asp:Panel>
                            </ItemTemplate>
                        </asp:TemplateField>
...
<div id="modalCalle" class="modal-overlay">
    <div class="modal-box">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h5 class="fw-bold mb-0" style="color:#0d2040;" id="modalTitulo">Nueva Calle de Rodaje</h5>
            <button type="button" class="btn-close" onclick="cerrarModal()"></button>
        </div>
        <asp:HiddenField ID="hfIdCalle" runat="server" Value="0" />
        <div class="row g-3">
            <div class="col-md-12">
            ...
            <div class="col-md-6">
                ...
                <asp:TextBox ID="txtDesignacion" runat="server" CssClass="form-control form-control-sm" placeholder="Ej: A1"></asp:TextBox>
            </div>
            <div class="col-md-6">
                ...
                <asp:DropDownList ID="ddlTipo" runat="server" CssClass="form-select form-select-sm">
                    ...
                    <asp:ListItem Text="Salida Rápida" Value="SALIDA_RAPIDA"></asp:ListItem>
                </asp:DropDownList>
            </div>
            <div class="col-md-6">
                <label class="form-label small fw-semibold">Longitud (m)</label>
                <asp:TextBox ID="txtLongitud" runat="server" CssClass="form-control form-control-sm" placeholder="500"></asp:TextBox>
            </div>
            <div class="col-md-6">
                <label class="form-label small fw-semibold">Ancho (m)</label>
                <asp:TextBox ID="txtAncho" runat="server" CssClass="form-control form-control-sm" placeholder="23"></asp:TextBox>
            </div>
...
<script>
    function abrirModal() { document.getElementById('modalCalle').classList.add('active'); document.getElementById('modalTitulo').innerText = 'Nueva Calle de Rodaje'; }
    function cerrarModal() { document.getElementById('modalCalle').classList.remove('active'); }
    function abrirModalEditar() { document.getElementById('modalTitulo').innerText = 'Editar Calle de Rodaje'; document.getElementById('modalCalle').classList.add('active'); }
</script>
</asp:Content>
